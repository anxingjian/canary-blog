...
const ENTRIES: Entry[] = [
  {
    ...
    tags: ["typography", "micro-animation", "minimal", "curve-text", "landing"],
  ...
  },
  {
    ...
    tags: ["scroll-interaction", "3d-cards", "editorial", "multi-style", "storytelling"],
  ...
  },
  {
    ...
    tags: ["3d", "three-js", "portfolio", "physical", "retro"],
  ...
  },
  {
    ...
    tags: ["3d", "three-js", "portfolio", "creative-dev"],
  ...
  },
  {
    ...
    tags: ["catalog", "concept", "data-viz", "personal"],
  ...
  },
  {
    ...
    tags: ["gallery", "animation", "product-page", "ai"],
  ...
  },
  {
    ...
    tags: ["portfolio", "scroll-animation", "parallax"],
  ...
  },
  {
    ...
    tags: ["portfolio", "cards", "responsive", "interaction"],
  ...
  },
  {
    ...
    why: "Blog 视觉改版灵感来源之一。",
    tags: ["portfolio", "editorial", "typography"],
  ...
  },
  {
    ...
    why: "Blog 视觉改版灵感来源之一。",
    tags: ["portfolio", "creative-dev", "3d"],
  ...
  },
  {
    ...
    tags: ["aggregator", "inspiration", "gallery"],
  ...
  },
  {
    ...
    tags: ["minimal", "typography", "animation", "benchmark"],
  ...
  },
  {
    ...
    tags: ["agency", "typography", "bold", "editorial"],
  ...
  },
  {
    ...
    tags: ["portfolio", "easter-egg", "personal"],
...
const TAG_COLORS: Record<string, string> = {
  "3d": "#6366f1", "three-js": "#6366f1",
  "typography": "#0ea5e9", "editorial": "#0ea5e9",
  "portfolio": "#10b981", "personal": "#10b981",
  "minimal": "#64748b", "clean": "#64748b",
  "animation": "#f59e0b", "micro-animation": "#f59e0b", "scroll-animation": "#f59e0b",
  "scroll-interaction": "#f59e0b", "parallax": "#f59e0b",
  "landing": "#ec4899", "product-page": "#ec4899",
  "creative-dev": "#8b5cf6",
  "concept": "#14b8a6", "catalog": "#14b8a6", "data-viz": "#14b8a6",
  "cards": "#f97316", "interaction": "#f97316", "responsive": "#f97316",
  "bold": "#ef4444",
  "ai": "#a855f7",
  "gallery": "#06b6d4",
  "aggregator": "#6b7280", "inspiration": "#6b7280",
  "benchmark": "#475569",
  "retro": "#92400e", "physical": "#92400e",
  "storytelling": "#dc2626", "multi-style": "#dc2626",
  "curve-text": "#0ea5e9",
  "3d-cards": "#6366f1",
  "easter-egg": "#a3e635",
  "agency": "#94a3b8",
