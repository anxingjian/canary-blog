...
const ENTRIES: Entry[] = [
  ...
  { id: "saberzou", name: "SaberOS", url: "https://saberzou.ai", desc: "macOS 桌面隐喻的个人站", why: "整个 portfolio 做成操作系统——窗口管理、Dock、右键菜单、Boot 动画全套。每个项目是桌面图标，点开是窗口内 iframe。形式即内容，站本身就是第 13 个作品。5000 行单文件，GSAP 动画，暖奶油配色。", tags: ["personal", "3d", "motion"], thumb: "/canary-blog/vault/saberzou-ai.jpg", date: "2026-04-21" },
